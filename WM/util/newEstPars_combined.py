...
def compute_rmse(css, ga, ia, stimTiming, correctResponses, subjResponses, targetTypes):
    ...
    modelVec = np.concatenate((scaled_modelRTs,model_tarAcc,model_lurAcc,model_nlrAcc), axis=None)
    subjVec = np.concatenate((scaled_subjRTs,subj_tarAcc,subj_lurAcc,subj_nlrAcc), axis=None)
...
#pickle.dump(results, open('/home/pjrice/gp/ACTR-WM/data/combined_parEst.p','wb'))
