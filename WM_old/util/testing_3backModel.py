...
path2device='Z:\\gp\\ACTR-WM\\code\\models\\twoBack\\threeBack-device.lisp'
...
axs[0,0].annotate('mean='+str(round(np.mean(totAccs),3)),xy=(0.85,30))

axs[0,1].hist(tarAccs,bins=7)
axs[0,1].set_title('Target accuracy')
axs[0,1].annotate('mean='+str(round(np.mean(tarAccs),3)),xy=(0.85,30))
    
axs[1,0].hist(lurAccs,bins=7)
axs[1,0].set_title('Lure accuracy')
axs[1,0].set_xlabel('acc %')
axs[1,0].set_ylabel('Count')
axs[1,0].annotate('mean='+str(round(np.mean(lurAccs),3)),xy=(0.85,30))

axs[1,1].hist(nlrAccs,bins=10)
axs[1,1].set_title('Nontarget accuracy')
axs[1,1].set_xlabel('acc %')
axs[1,1].annotate('mean='+str(round(np.mean(nlrAccs),3)),xy=(0.85,30))
