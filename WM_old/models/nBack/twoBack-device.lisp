...
;;; list to store model retrieval buffer chunk on response
(defparameter *retrievalChunks* '())
...
(defparameter *task-stimuli* '(( 
							  ((two nil nil) (body BP_002_BP10_BA.png) (body BP_001_BP1_BA.png) (body BP_006_BP2_BA.png) (body BP_001_BP1_BA.png) (body BP_005_BP19_BA.png) (body BP_003_BP16_BA.png) (body BP_006_BP2_BA.png) (body BP_004_BP18_BA.png) (body BP_005_BP19_BA.png) (body BP_004_BP18_BA.png))
							  ((two nil nil) (tool TO_001_TOOL1_BA.png) (tool TO_002_TOOL2_BA.png) (tool TO_004_TOOL4_BA.png) (tool TO_002_TOOL2_BA.png) (tool TO_001_TOOL1_BA.png) (tool TO_004_TOOL4_BA.png) (tool TO_006_TOOL6_BA.png) (tool TO_005_TOOL5_BA.png) (tool TO_006_TOOL6_BA.png) (tool TO_003_TOOL3_BA.png))
							  ((two nil nil) (face FC_010_F5.png) (face FC_012_F6.png) (face FC_010_F5.png) (face FC_008_F4.png) (face FC_012_F6.png) (face FC_008_F4.png) (face FC_007_M4.png) (face FC_007_M4.png) (face FC_009_M5.png) (face FC_011_M6.png))
							  ((two nil nil) (place PL_007_92026.png) (place PL_007_92026.png) (place PL_010_92038.png) (place PL_009_92037.png) (place PL_010_92038.png) (place PL_009_92037.png) (place PL_008_92033.png) (place PL_012_92047.png) (place PL_012_92047.png) (place PL_011_92044.png))
							 ) ;;; end session 1
							 ( 
							  ((two nil nil) (tool TO_014_TOOL14_BA.png) (tool TO_013_TOOL13_BA.png) (tool TO_016_TOOL16_BA.png) (tool TO_014_TOOL14_BA.png) (tool TO_016_TOOL16_BA.png) (tool TO_018_TOOL18_BA.png) (tool TO_017_TOOL17_BA.png) (tool TO_018_TOOL18_BA.png) (tool TO_015_TOOL15_BA.png) (tool TO_017_TOOL17_BA.png))
							  ((two nil nil) (face FC_015_M8.png) (face FC_018_F9.png) (face FC_018_F9.png) (face FC_017_M9.png) (face FC_017_M9.png) (face FC_016_F8.png) (face FC_013_M7.png) (face FC_014_F7.png) (face FC_013_M7.png) (face FC_014_F7.png))
							  ((two nil nil) (body BP_020_H17-T_BA.png) (body BP_019_H14-T_BA.png) (body BP_020_H17-T_BA.png) (body BP_019_H14-T_BA.png) (body BP_024_H3-T_BA.png) (body BP_024_H3-T_BA.png) (body BP_025_H5-T_BA.png) (body BP_023_H25-T_BA.png) (body BP_022_H24-T_BA.png) (body BP_022_H24-T_BA.png))
							  ((two nil nil) (place PL_019_SCENE_05.png) (place PL_017_SCENE_03.png) (place PL_017_SCENE_03.png) (place PL_016_SCENE_02.png) (place PL_015_SCENE_01.png) (place PL_016_SCENE_02.png) (place PL_015_SCENE_01.png) (place PL_020_SCENE_06.png) (place PL_020_SCENE_06.png) (place PL_018_SCENE_04.png))
							 ) ;;; end session 2
							)
)
...
(defun read-retrieval-slots (&optional (slots '(item)))
  "Reads the contents of the imaginal buffer and returns them as a list"
  (let ((nwindow (first (no-output (buffer-chunk-fct '(retrieval))))))
    (if nwindow
        (mapcar #'(lambda (x)
                    (chunk-slot-value-fct nwindow x))
                slots)
...
(defun collect-retrieval-slots ()
	(push (read-retrieval-slots) *retrievalChunks*)
)
...
(defun runTaskFromPython ()
	...
	(setf *imaginalChunks* '())
	(setf *retrievalChunks* '())
	(setf *numResponses* 0)
	(setf *numTrials* 0)
	(load "Z:\\gp\\ACTR-WM\\code\\models\\nBack\\nBack-model-chunks.lisp")
	;;;(load "/home/pjrice/gp/ACTR-WM/code/models/nBack/nBack-model-chunks.lisp")
...
(defun print-retrieval-chunks ()
	(print *retrievalChunks*)
)
(add-act-r-command "print-retrieval-chunks" 'print-retrieval-chunks)

(defun print-num-responses ()
	(print *numResponses*)
)
(add-act-r-command "print-num-responses" 'print-num-responses)
